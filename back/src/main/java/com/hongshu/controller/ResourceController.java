...
public class ResourceController
{
     ...
     * @return {@link Result<>}
     */
    @ApiOperation(value = "修改资源是否匿名访问")
    @PostMapping("/admin/resources/change")
    public Result<?> changeResource(@RequestBody @Valid ConditionVO conditionVO)
    {
        resourceService.changeResource(conditionVO);
        return Result.ok();
    }
